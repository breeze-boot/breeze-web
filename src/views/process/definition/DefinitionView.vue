  ...
  <el-container>
    <el-main>
      ...
      <div style="margin-bottom: 10px; text-align: left;">
        <el-button v-has="['process:definition:create']" plain size="mini" type="primary" @click="create">新建</el-button>
      </div>
      <el-table
        ref="multipleTable"
        ...
        <el-table-column
          ...
          width="240">
          <template slot-scope="scope">
            <el-button v-has="['process:instance:start']" size="mini" type="text" @click="startProcess(scope.row)">
              开启
            </el-button>
            <el-button v-has="['process:designer']" size="mini" type="text" @click="latestProcessDesigner(scope.row)">
              设计
            </el-button>
            <el-button v-has="['process:definition:info']" size="mini" type="text" @click="viewImage(scope.row)">流程图片
            </el-button>
            <el-button v-has="['process:definition:info']" size="mini" type="text" @click="viewVersion(scope.row)">查看版本
            </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog :title="title" :visible.sync="definitionVersionDialogVisible" width="80vw">
      <el-table
        ...
        <el-table-column
          ...
          width="200">
          <template slot-scope="scope">
            <el-button v-has="['process:definition:info']" size="mini" type="text" @click="viewVersionImage(scope.row)">
              流程图片
            </el-button>
            <el-button v-has="['process:designer']" size="mini" type="text" @click="versionProcessDesigner(scope.row)">
              设计
            </el-button>
            <el-button v-has="['process:definition:suspended']" size="mini" type="text" @click="isSuspended(scope.row)">
              {{ scope.row.suspended ? '激活' : '挂起' }}
            </el-button>
            <el-button v-has="['process:definition:delete']" size="mini" type="text"
