    ...
    <el-main>
      ...
      <el-table
        ...
        <el-table-column
          ...
          width="200"/>
        <el-table-column
          :formatter="(row, column) => this.column()(row, column, 'JOB_GROUP')"
          label="任务组名"
          prop="jobGroupName"
          show-overflow-tooltip
          width="150"/>
        ...
        <el-table-column
          ...
          width="300"/>
        <el-table-column
          :formatter="(row, column) => this.column()(row, column, 'MISFIRE_POLICY')"
          label="执行策略"
          prop="misfirePolicy"
          show-overflow-tooltip>
        </el-table-column>
        <el-table-column
          :formatter="(row, column) => this.column()(row, column, 'CONCURRENT')"
          label="并发"
          prop="concurrent"
          show-overflow-tooltip
          width="60"/>
    ...
    <el-dialog :title="title" :visible.sync="infoDialogVisible" width="40vw"
      ...
      <el-descriptions :column="2" border size="mini">
        ...
        <el-descriptions-item label="执行策略">
          {{ this.descriptions()(job, 'misfirePolicy', 'MISFIRE_POLICY') }}
        </el-descriptions-item>
        <el-descriptions-item label="并发">
          {{ this.descriptions()(job, 'concurrent', 'CONCURRENT') }}
        </el-descriptions-item>
        <el-descriptions-item label="状态">
          {{ this.descriptions()(job, 'status', 'JOB_STATUS') }}
        </el-descriptions-item>
      </el-descriptions>
    </el-dialog>
