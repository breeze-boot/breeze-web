  ...
  <el-container>
    <el-main>
      ...
      <div style="margin-bottom: 10px; text-align: left;">
        <el-button v-has="['upms:user:create']" plain size="mini" type="primary" @click="create">新建</el-button>
        <el-button v-has="['upms:user:delete']" :disabled="checkDeleteItem" plain size="mini" type="danger"
                   @click="remove">删除
        </el-button>
        <el-button v-has="['upms:user:export']" plain size="mini" type="info" @click="exportInfo">导出</el-button>
        <el-button v-has="['upms:user:import']" plain size="mini" @click="importInfo">导入</el-button>
      </div>
      <el-table
        ref="userTable"
        :data="userTableData"
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button v-has="['upms:user:modify']" size="mini" type="text" @click="edit(scope.row)">编辑</el-button>
            <el-button v-has="['upms:user:delete']" size="mini" type="text"
            ...
            <el-dropdown size="mini" style="margin-left: 5px;" trigger="click" type="primary">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item v-has="['upms:user:resetPass']" command="1" @click.native="resetPass(scope.row)">重置密码
                </el-dropdown-item>
                <el-dropdown-item v-has="['upms:user:userSetRole']" command="2" @click.native="goRoleView(scope.row)"
                >角色分配
                </el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
...
import { upload } from '@/api/upms/file'
