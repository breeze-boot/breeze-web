  ...
  <el-container>
    <el-main>
      ...
      <div style="margin-bottom: 10px; text-align: left;">
        <el-button v-has="['upms:post:create']" plain size="mini" type="primary" @click="create">新建</el-button>
        <el-button v-has="['upms:post:delete']"
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button v-has="['upms:post:modify']" size="mini" type="text" @click="edit(scope.row)">编辑</el-button>
            <el-button v-has="['upms:post:delete']" size="mini" type="text"
...
<script>
import { checkPostCode, del, list, modify, save } from '@/api/upms/post'
