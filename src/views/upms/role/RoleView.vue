      ...
      <el-row :gutter="24">
        <el-col :md="19">
          <div style="margin-bottom: 10px; text-align: left;">
            <el-button v-has="['upms:role:create']" plain size="mini" type="primary" @click="create">新建</el-button>
            <el-button v-has="['upms:role:delete']" :disabled="checkDeleteItem" plain size="mini" type="danger"
                       @click="remove">删除
            </el-button>
          </div>
          <el-table
            ...
            <el-table-column>
              ...
              <template slot-scope="scope">
                ...
                <el-button v-has="['upms:role:modify']" size="mini" type="text" @click="edit(scope.row)">编辑</el-button>
                <el-button v-has="['upms:dataPermission:editRoleDataPermission']" size="mini" type="text"
                           @click="editRoleDataPermission(scope.row)">数据权限
                </el-button>
                <el-button v-has="['upms:role:delete']" size="mini" type="text"
...
<script>
import { checkRoleCode, del, list, listRolesPermission, modify, modifyPermission, save } from '@/api/upms/role'
import { listTreePermission } from '@/api/upms/menu'
import { confirmAlert, DIALOG_TYPE, reLoginConfirm } from '@/utils/constant'
import JSONBigInt from 'json-bigint'
import { editRoleDataPermission, selectDataPermission } from '@/api/upms/dataPermission'
