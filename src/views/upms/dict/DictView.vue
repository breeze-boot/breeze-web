  ...
  <el-container>
    <el-main>
      ...
      <div style="margin-bottom: 10px; text-align: left;">
        <el-button v-has="['upms:dict:create']" plain size="mini" type="primary" @click="create">新建</el-button>
        <el-button v-has="['upms:dict:delete']" :disabled="checkDeleteItem" plain size="mini" type="danger"
                   @click="remove">删除
        </el-button>
      </div>
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button v-has="['upms:dict:modify']" size="mini" type="text" @click="edit(scope.row)">编辑</el-button>
            <el-button v-has="['upms:dict:delete']" size="mini" type="text"
...
<script>
import { checkDictCode, del, list, modify, open, save } from '@/api/upms/dict'
