  ...
  <el-container>
    <el-main>
      ...
      <div style="margin-bottom: 10px; text-align: left;">
        <el-button v-has="['upms:dept:create']" plain size="mini" type="primary" @click="create">新建</el-button>
      </div>
      <el-table
        :data="deptTableData"
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button v-has="['upms:dept:create']" size="mini" type="text" @click="create(scope.row)">新建</el-button>
            <el-button v-has="['upms:dept:modify']" size="mini" type="text" @click="edit(scope.row)">编辑</el-button>
            <el-button v-has="['upms:dept:delete']" size="mini" type="text"
...
<script>
import { checkDeptCode, del, list, modify, save, selectDept } from '@/api/upms/dept'
