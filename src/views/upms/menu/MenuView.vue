  ...
  <el-container>
    <el-main>
      ...
      <div style="margin-bottom: 10px; text-align: left;">
        <el-button v-has="['upms:menu:create']" plain size="mini" type="primary" @click="create">新建</el-button>
      </div>
      <el-table
        ref="menuTable"
        :data="menuTableData"
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button v-has="['upms:menu:create']" size="mini" type="text" @click="create(scope.row)">新建</el-button>
            <el-button v-has="['upms:menu:modify']" size="mini" type="text" @click="edit(scope.row)">编辑</el-button>
            <el-button v-has="['upms:menu:delete']" size="mini" type="text"
...
<script>
import { del, list, modify, save, selectMenu, selectPlatform } from '@/api/upms/menu'
