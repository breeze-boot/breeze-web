  ...
  <el-container>
    <el-main>
      ...
      <div style="margin-bottom: 10px; text-align: left;">
        <el-button v-has="['upms:file:upload']" plain size="mini" type="primary" @click="create">新建</el-button>
        <el-button v-has="['upms:file:delete']" :disabled="checkDeleteItem" plain size="mini" type="danger"
                   @click="remove">删除
        </el-button>
      </div>
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button v-has="['upms:file:preview']" size="mini" type="text" @click="preview(scope.row)">预览</el-button>
            <el-button v-has="['upms:file:download']" size="mini" type="text" @click="download(scope.row)">下载</el-button>
            <el-button size="mini" type="text" @click="info(scope.row)">查看</el-button>
            <el-button v-has="['upms:file:modify']" size="mini" type="text" @click="edit(scope.row)">更新</el-button>
            <el-button v-has="['upms:file:delete']" size="mini" type="text"
...
<script>
import { del, download, list, preview, upload } from '@/api/upms/file'
