  ...
  <el-container>
    <el-main>
      ...
      <div style="margin-bottom: 10px; text-align: left;">
        <el-button v-has="['upms:log:export']" plain size="mini" type="info" @click="exportInfo">导出</el-button>
        <el-button v-has="['upms:log:delete']" :disabled="checkDeleteItem" plain size="mini" type="danger"
                   @click="remove">删除
        </el-button>
        <el-button v-has="['upms:log:clear']" plain size="mini" type="danger" @click="clear">清空全表</el-button>
      </div>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button v-has="['upms:log:delete']" size="mini" type="text"
