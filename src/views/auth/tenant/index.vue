  ...
  <base-container>
    <el-main>
      ...
      <div style="margin-bottom: 10px; text-align: left;">
        <el-button v-has="['auth:tenant:create']" plain size="mini" type="primary" @click="handleCreate">新建</el-button>
        <el-button v-has="['auth:tenant:delete']" :disabled="checkDelete" plain size="mini" type="danger"
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button v-has="['auth:tenant:modify']" size="mini" type="text" @click="handleEdit(scope.row)">编辑
            </el-button>
            <el-button v-has="['auth:tenant:delete']" size="mini" type="text"
...
<script>
import { checkTenantCode, del, list, modify, save } from '@/api/auth/tenant'
