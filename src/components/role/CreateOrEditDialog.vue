<template>
  <el-dialog width="800px" :title="title" :visible.sync="dialogFormVisible"
    ...
    <el-form size="mini" :rules="rules" :disabled="!show" ref="ruleForm" :model="role">
      <el-form-item label="平台名称" prop="roleName" :label-width="formLabelWidth">
        <el-input v-model="role.roleName" autocomplete="off" clearable></el-input>
      </el-form-item>
      <el-form-item label="平台标志" prop="roleCode" :label-width="formLabelWidth">
        <el-input v-model="role.roleCode" autocomplete="off" clearable></el-input>
      </el-form-item>
      <el-form-item label="描述" :label-width="formLabelWidth">
        <el-input type="textarea" v-model="role.desc" autocomplete="off" clearable></el-input>
      </el-form-item>
    </el-form>
